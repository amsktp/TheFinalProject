...
<%-- 						<td><span><input type="text" name='memberPassword' value="${memberFileDto.memberPassword}"></span></td> --%>
			...
			<input class="btn btn-primary btn-lg pull-right" style="margin-left: 20px" type='submit' value='변경하기'>
				<input class="btn btn-default btn-lg pull-right" type='button' value='돌아가기' onClick='myInfoMoveFnc();'>
			</form>
