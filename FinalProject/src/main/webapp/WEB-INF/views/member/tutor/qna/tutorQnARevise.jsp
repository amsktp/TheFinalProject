...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#okBtn').on('click', function() {
			...
			$('form').attr('action', './tutorQnAReviseCtr.do');
		});
				...
				<form method="post">
					...
					<table id='qnaReviceTable' class="table table-bordered">
						...
						<tr>
							...
							<td><div class="textCenter">${questionBoardDto.boardNo}</div> 
								<input id='idx' type="hidden" name='idx' value='${questionBoardDto.boardNo}'>
							</td>
						...
						<tr>
							...
							<input id="cancelBtn" class="btn btn-default" type="button" value="취소"	onclick="moveFnc('./tutorQnARead.do?idx=${questionBoardDto.boardNo}')">
