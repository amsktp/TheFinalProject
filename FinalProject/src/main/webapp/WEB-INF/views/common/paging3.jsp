...
.page_nation .pprev {
	background:#f8f8f8 url('/englishvillage/resources/imgs/page_pprev.png') no-repeat center center;
	margin-left:0;
}
.page_nation .prev {
	background:#f8f8f8 url('/englishvillage/resources/imgs/page_prev.png') no-repeat center center;
	margin-right:7px;
}
.page_nation .next {
	background:#f8f8f8 url('/englishvillage/resources/imgs/page_next.png') no-repeat center center;
	margin-left:7px;
}
.page_nation .nnext {
	background:#f8f8f8 url('/englishvillage/resources/imgs/page_nnext.png') no-repeat center center;
	margin-right:0;
}
